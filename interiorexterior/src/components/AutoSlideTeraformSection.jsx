...
const images = [img5, img6, img7,  img9, img10, img1, img2, img3, img4];
  ...
  return (
    <Box
      sx={{
        ...
        py: { xs: 4, sm: 5, md: 4 },
        background:
          "linear-gradient(305deg, #FCF9EA 0%, #ffffff 50%, #ffffffff 100%)",
      }}
    >
      <motion.div
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              As premier painting contractors, we deliver exceptional value and
              unmatched quality for both commercial and residential properties.
              Our comprehensive services enhance aesthetic appeal while ensuring
              lasting durability.
            </Typography>
          </motion.div>
              ...
              {images.map((_, i) => (
                <Box
                  ...
                  sx={{
                    ...
                    borderRadius: 6,
                    bgcolor:
                      currentIndex === i ? "#63cbe0" : "rgba(255,255,255,0.6)",
                    cursor: "pointer",
                    transition: "all 0.3s ease",
                    "&:hover": {
                      bgcolor:
