    ...
    >
      ...
      <Chip
        ...
        sx={{
          ...
          top: -12,
          right: 16,
          background: highlighted ? "#fff" : "#0097b1",
          color: highlighted ? "#0097b1" : "#fff",
          fontWeight: 800,
          fontSize: 12,
          height: 24,
          minWidth: 40,
    ...
    >
      ...
      {/* <Box
        sx={{
          ...
          borderRadius: "50%",
          background: "linear-gradient(15deg, #63cbe0 0%, transparent 70%)",
          opacity: 0.4,
        }}
      /> */}
      <Box
      ...
      >
        {/* <img
          src={img2}
          alt="img"
          style={{ width: "100vh", height: "100vh", objectFit: "contain" }}
        /> */}
      </Box>
      ...
      <Container maxWidth="xl">
        ...
        >
          ...
          >
            Our experienced team brings creativity and precision to every
            project, delivering exceptional results that exceed expectations and
        ...
        >
          <Button
            ...
            endIcon={<ArrowForwardIcon />}
            sx={{
              background: "linear-gradient(135deg, #0097b1 0%, #63cbe0 100%)",
              borderRadius: 3,
              px: 4,
              py: 1.5,
              fontSize: 16,
